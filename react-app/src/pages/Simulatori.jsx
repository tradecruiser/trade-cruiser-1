...
const simulators = [
  { chapter: 1,  title: 'Hedge or Expose',      type: 'P&L Simulation',     Icon: Scale, to: '/simulators/hedge-expose', description: 'Run a physical cargo with and without a hedge and watch each P&L react as the flat price moves.' },
  { chapter: 2,  title: 'Crude Classifier',     type: 'Sorting Game',       Icon: FlaskConical, to: '/simulators/crude-classifier', description: 'Sort crude samples by API gravity and sulfur content into light/heavy and sweet/sour grades.' },
  { chapter: 3,  title: 'Terminology Trainer',  type: 'Quiz',               Icon: GraduationCap, to: '/simulators/terminology-trainer', description: 'Match trading terms to live scenarios: long vs short, bid-offer, slippage, open interest, VaR.' },
  { chapter: 4,  title: 'Refinery Flow',        type: 'Process Builder',    Icon: Factory, to: '/simulators/refinery-flow', description: 'Route a barrel through distillation, conversion, and treatment to build the right product slate.' },
  { chapter: 5,  title: 'Benchmark Map',        type: 'Map Matching',       Icon: MapIcon, to: '/simulators/benchmark-map', description: 'Place global crude benchmarks — Brent, WTI, Dubai — on the map and match them to their grades.' },
  ...
  { chapter: 12, title: 'Arbitrage Run',        type: 'P&L Simulation',     Icon: TrendingUp,    to: '/simulators/arbitrage-run', description: 'Spot a price gap between two regions, subtract freight, and decide if the arbitrage is worth it.' },
  { chapter: 13, title: 'Quality Spread',       type: 'P&L Simulation',     Icon: Layers,        to: '/simulators/quality-spread', description: 'Trade the differential between high- and low-sulfur grades as quality premiums move.' },
  { chapter: 14, title: 'Curve Trader',         type: 'Interactive Chart',  Icon: Activity,      to: '/simulators/curve-trader', description: 'Read the forward curve, trade calendar spreads, and profit from contango and backwardation.' },
  { chapter: 15, title: 'VaR Simulator',        type: 'Risk Simulation',    Icon: ShieldAlert,   to: '/simulators/var-simulator', description: 'Size your positions against a risk limit and watch Value-at-Risk and the P&L distribution respond.' },
  { chapter: 16, title: 'Exposure Tracker',     type: 'Decision Sim',       Icon: Target,        to: '/simulators/exposure-tracker', description: 'A physical deal lands — identify the open price exposure and place the hedge that neutralizes it.' },
