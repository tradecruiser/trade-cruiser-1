...
const simulators = [
  ...
  { chapter: 9,  title: 'Margin Call Simulator', type: 'Risk Simulation',   Icon: Coins,    description: 'Hold a leveraged futures position and watch your margin balance erode as prices move against you — top up collateral before the margin call triggers liquidation.' },
  { chapter: 10, title: 'Contract Builder',     type: 'Interactive Builder', Icon: FileSignature, description: 'Build and settle futures, forwards, and swaps, then compare how each one pays out at expiry.' },
